            ...
            if (sheet != null)
            {
                ...
                while(index < sheet.LastRowNum)
                {
                    ...
                    IStudent student = new Student()
                    {
                        ...
                        Sex = cells.GetCell(10).StringCellValue == "男" ? Sex.Male : Sex.Female,
                        IsLodge = cells.GetCell(11).StringCellValue == "寄宿" ? true: false,
                        IsDowntown = cells.GetCell(9).StringCellValue == "市直" ? true : false,
                    };
